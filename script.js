...
const skillInfo = {
    ...
    "Python": "Python is a high-level, easy-to-read programming language used for building websites, automating tasks, analzying data and more."
};
...
skillButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        skillDescription.style.color = 'rgb(129, 108, 125)'; 
    });
});
